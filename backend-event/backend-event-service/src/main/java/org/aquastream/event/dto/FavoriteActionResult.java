...
public record FavoriteActionResult(UUID eventId, boolean isFavorited, String message) {
    ...
    public static FavoriteActionResult alreadyExists(UUID eventId) {
        return new FavoriteActionResult(eventId, true, "Event already in favorites");
    }
}
