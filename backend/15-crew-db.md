# T15. Crew: схема БД и миграции Liquibase
...
## Цель
Создать схему `crew` для групп/лодок/палаток и назначений.

## Результат (Deliverables)
- Таблицы: `crews`, `crew_assignments`, `boats`, `tents`, `team_preferences`

## Шаги
1. Опиши ограничения вместимости и уникальность назначений.
2. Проверка миграций через `update-sql` и локальный `update`.

## Критерии приёмки (AC)
- Миграции применяются; ограничения enforced в БД и сервисе.

## Definition of Done (DoD)
- Документация связей и бизнес‑правил.
