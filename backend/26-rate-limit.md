# T26. Rate‑limit: Bucket4j (login/recovery/default) + 429 Retry‑After
...
## Цель
Установить мягкие лимиты и консистентные ответы 429.

## Результат (Deliverables)
- Конфиги лимитов в YAML; фильтр Bucket4j

## Шаги
1. Подключить Bucket4j и описать правила для login/recovery/default.
2. Вернуть 429 с Problem Details и `Retry-After`.

## Критерии приёмки (AC)
- Превышение лимитов корректно фиксируется и логируется.

## Definition of Done (DoD)
- Документация примеров ответов/заголовков.
