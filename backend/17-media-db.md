# T17. Media: схема БД и миграции Liquibase
...
## Цель
Создать схему `media` и учёт объектов (ключ/тип/размер/владелец).

## Результат (Deliverables)
- Таблица `files` (owner_type/id, key, checksum, content_type, size, created_at)

## Шаги
1. Описать индексы по key/owner.

## Критерии приёмки (AC)
- Миграция применяется, таблица готова.

## Definition of Done (DoD)
- Документация ключей и политик доступа к объектам.
