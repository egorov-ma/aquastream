...
## Цель
Настроить SemVer теги и публикацию Release заметок.

## Результат (Deliverables)
- Теги `vX.Y.Z`, релиз GH, CHANGELOG шаблон

## Шаги
1. Добавить шаг публикации Release в CI.
2. Описать правила инкремента версий.

## Критерии приёмки (AC)
- По тегу появляется Release и помеченные образы.

## Definition of Done (DoD)
- Документация процесса релизов в корне репозитория.
