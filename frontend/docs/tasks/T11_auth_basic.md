...
- Коммиты — в стиле Conventional Commits (напр., `feat(T11): краткое описание`).  
- Открой PR и сослаться на: `/frontend/docs/AquaStream_Business_Spec_v1.1.md` и `/frontend/docs/tasks/T11.md`.
