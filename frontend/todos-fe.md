...
## 1. Зафиксировать стабильный стек
...
## 2. Выровнять шрифты и дизайн-токены
...
## 3. Реализовать Collapsed Sidebar до конца
...
## 4. Нормализовать layout- и типографические примитивы
...
## 5. Убедиться в совместимости `tailwind-merge`
...
## 6. Проверить toolchain на новые CSS-селекторы
...
## 7. Консолидировать использование shadcn-компонентов
...
## 8. Создать Frontend Design Playbook (docs-as-code)
...
## 9. Настроить защиту от визуальных регрессий
